...
#	endif
	...
	struct compute_mod
	{
		...
		{
			GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559, "'mod' only accept floating-point inputs. Include <Engine/Libraries/glm/gtc/integer.hpp> for integer inputs.");
